                ...
                <G data-name="Group 12">
                    ...
                    <G data-name="Group 9">
                        <G data-name="Group 7">
                            ...
                            <Path
                                data-name="Path 3"
                                d="M150.359 178.598s-8.331 2.923-11.581 6.806c-3.556 4.25-6.266 11.309-6.266 11.309l63.03 23.67z"
                                fill="#96959e"
                            />
                            <Path
                                data-name="Path 31"
                                d="M211.35 178.495s8.332 2.923 11.58 6.806c3.553 4.25 6.267 11.31 6.267 11.31l-63.03 23.67z"
                                fill="#96959e"
                            />
                            <Path
                                data-name="Path 6"
                            ...
                            <Path
                                data-name="Path 8"
                                d="M176.983 359.98l-1.714-141.479 2.393-5.37 1.714 146.787z"
                                fill="#96959e"
                            />
                            <Path
                                data-name="Path 10"
                            ...
                            <G
                                ...
                                <Path
                                    ...
                                    d="M32.531 36.736h26.758v44.247H44.881a12.35 12.35 0 01-12.35-12.347v-31.9z"
                                    fill="#4c2d22"
                                />
                                <Path
                                    data-name="Rectangle 4"
                                    d="M137.955 80.982V47.409h10.847v22.726a10.847 10.847 0 01-10.847 10.847z"
                                    fill="#4c2d22"
                                />
                                <Path
                                    data-name="Path 12"
                                ...
                                <Path
                                    data-name="Path 30"
                                    d="M148.802 29.358V51.54a170 170 0 01-57.6-12.86C61.98 26.208 32.529 51.541 32.529 51.541s-.328-37.032 0-37.062c19.262-9.36 1.4-24.655 58.673-24.655s47.665 22.713 47.665 22.713c6.821 0 9.935 8.603 9.935 16.821z"
                                    fill="#4c2d22"
                                />
                                <G data-name="Group 3">
                                    <Path
                                    ...
                                    <G
                                        ...
                                        <G data-name="Group 1" fill="#1c1106">
                                            <Path
